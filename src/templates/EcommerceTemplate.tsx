      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-brand-steel text-sm mb-4">Have questions? Chat with us on WhatsApp.</p>
            <a
              href="https://wa.me/5215500000000?text=Hi,%20I%20have%20a%20question%20about%20the%20Rodata%20One%20Lumbar%20Support"
              target="_blank"
